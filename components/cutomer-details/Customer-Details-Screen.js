...
export default class CustomerDetailsScreen extends Component {
    ...
    submitPressed() {
        ...
        Alert.alert(
            ...
            [
                { text: 'OK', onPress: () => this.props.navigation.navigate('Home', { name: 'Jane' }) },
            ],
            { cancelable: false }
        )
    }
            ...
            >
                <View style={styles.container}>
                    ...
                    <View style={styles.checkboxContainer}>
                        <Text style={styles.label}>Payment Option : CASH ON DELIVERY ONLY!</Text>
                    </View>

                    <View style={styles.btnContainer}>
                        <Button color='green' title="Submit" onPress={this.submitPressed} />
                    </View>
